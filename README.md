...
[cartographer](https://github.com/cartographer-project/cartographer) ⭐ 7,941 | 🐛 242 | 🌐 C++ | 📅 2024-01-05 can easily be setup with IMU to improve localization.
...
* [camsense-X1](https://github.com/Vidicon/camsense-X1) ⭐ 72 | 🐛 1 | 📅 2020-10-03 - Unofficial reverse engineering of a Chinese LiDAR. `GPL-3.0`
...
* [Valetudo](https://github.com/Hypfer/Valetudo) ⭐ 9,531 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-12 - Cloud-free control webinterface for vacuum robots. `Apache-2.0` `JavaScript`
...
* [Valetudo RE](https://github.com/rand256/valetudo) ⭐ 707 | 🐛 35 | 🌐 JavaScript | 📅 2025-08-19 - Experimental vacuum software, cloud free (Valetudo Fork) `Apache-2.0` `JavaScript`
...
* [Gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,446 | 🐛 99 | 🌐 Go | 📅 2026-01-07 - Golang framework for robotics, drones, and the Internet of Things (IoT).  `Apache-2.0` `golang`
...
* [cartographer](https://github.com/cartographer-project/cartographer) ⭐ 7,941 | 🐛 242 | 🌐 C++ | 📅 2024-01-05 - A system that provides real-time simultaneous localization and mapping (SLAM) in 2D and 3D across multiple platforms and sensor configurations. `Apache-2.0` `C++`
...
* [Awesome Robotic Tooling](https://github.com/protontypes/awesome-robotic-tooling) ⭐ 3,875 | 🐛 13 | 📅 2023-11-20
