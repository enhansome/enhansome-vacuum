...
[cartographer](https://github.com/cartographer-project/cartographer) ⭐ 7,942 | 🐛 242 | 🌐 C++ | 📅 2024-01-05 can easily be setup with IMU to improve localization.
...
* [Valetudo](https://github.com/Hypfer/Valetudo) ⭐ 9,535 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-14 - Cloud-free control webinterface for vacuum robots. `Apache-2.0` `JavaScript`
...
* [cartographer](https://github.com/cartographer-project/cartographer) ⭐ 7,942 | 🐛 242 | 🌐 C++ | 📅 2024-01-05 - A system that provides real-time simultaneous localization and mapping (SLAM) in 2D and 3D across multiple platforms and sensor configurations. `Apache-2.0` `C++`
...
* [Awesome Robotic Tooling](https://github.com/protontypes/awesome-robotic-tooling) ⭐ 3,877 | 🐛 13 | 📅 2023-11-20
