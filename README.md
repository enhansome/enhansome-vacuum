...
[cartographer](https://github.com/cartographer-project/cartographer) ⭐ 7,975 | 🐛 241 | 🌐 C++ | 📅 2024-01-05 can easily be setup with IMU to improve localization.
...
* [Valetudo](https://github.com/Hypfer/Valetudo) ⭐ 9,708 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-18 - Cloud-free control webinterface for vacuum robots. `Apache-2.0` `JavaScript`
...
* [Valetudo RE](https://github.com/rand256/valetudo) ⭐ 713 | 🐛 34 | 🌐 JavaScript | 📅 2025-08-19 - Experimental vacuum software, cloud free (Valetudo Fork) `Apache-2.0` `JavaScript`
* [Bumper](https://github.com/bmartin5692/bumper) ⭐ 399 | 🐛 58 | 🌐 Python | 📅 2024-08-05 - A standalone and self-hosted implementation of the central server used by Ecovacs vacuum robot. `GPL-3.0` `Python`
...
* [Gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,475 | 🐛 100 | 🌐 Go | 📅 2026-01-07 - Golang framework for robotics, drones, and the Internet of Things (IoT).  `Apache-2.0` `golang`
...
* [cartographer](https://github.com/cartographer-project/cartographer) ⭐ 7,975 | 🐛 241 | 🌐 C++ | 📅 2024-01-05 - A system that provides real-time simultaneous localization and mapping (SLAM) in 2D and 3D across multiple platforms and sensor configurations. `Apache-2.0` `C++`
* [OpenVSLAM](https://github.com/xdspacelab/openvslam) ⚠️ Archived - A Versatile Visual SLAM Framework. `2-Clause BSD` `C++`
* [BreezySLAM](https://github.com/simondlevy/BreezySLAM) ⭐ 813 | 🐛 57 | 🌐 C | 📅 2026-02-05 - Simple, efficient, open-source package for Simultaneous Localization and Mapping. `LGPLv3` `Various`
...
* [Awesome Robotic Tooling](https://github.com/protontypes/awesome-robotic-tooling) ⭐ 3,893 | 🐛 15 | 📅 2023-11-20
