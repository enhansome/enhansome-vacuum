...
* [Valetudo](https://github.com/Hypfer/Valetudo) ⭐ 9,709 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-25 - Cloud-free control webinterface for vacuum robots. `Apache-2.0` `JavaScript`
...
* [Gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,474 | 🐛 100 | 🌐 Go | 📅 2026-01-07 - Golang framework for robotics, drones, and the Internet of Things (IoT).  `Apache-2.0` `golang`
...
* [Awesome Robotic Tooling](https://github.com/protontypes/awesome-robotic-tooling) ⭐ 3,893 | 🐛 13 | 📅 2023-11-20
