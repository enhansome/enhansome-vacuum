...
[cartographer](https://github.com/cartographer-project/cartographer) ⭐ 7,969 | 🐛 241 | 🌐 C++ | 📅 2024-01-05 can easily be setup with IMU to improve localization.
...
* [cartographer](https://github.com/cartographer-project/cartographer) ⭐ 7,969 | 🐛 241 | 🌐 C++ | 📅 2024-01-05 - A system that provides real-time simultaneous localization and mapping (SLAM) in 2D and 3D across multiple platforms and sensor configurations. `Apache-2.0` `C++`
