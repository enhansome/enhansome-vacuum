...
* [Valetudo](https://github.com/Hypfer/Valetudo) ⭐ 9,642 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-04 - Cloud-free control webinterface for vacuum robots. `Apache-2.0` `JavaScript`
...
* [Gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,465 | 🐛 100 | 🌐 Go | 📅 2026-01-07 - Golang framework for robotics, drones, and the Internet of Things (IoT).  `Apache-2.0` `golang`
