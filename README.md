...
[cartographer](https://github.com/cartographer-project/cartographer) ⭐ 7,945 | 🐛 242 | 🌐 C++ | 📅 2024-01-05 can easily be setup with IMU to improve localization.
...
* [camsense-X1](https://github.com/Vidicon/camsense-X1) ⭐ 73 | 🐛 1 | 📅 2020-10-03 - Unofficial reverse engineering of a Chinese LiDAR. `GPL-3.0`
...
* [Valetudo](https://github.com/Hypfer/Valetudo) ⭐ 9,545 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-15 - Cloud-free control webinterface for vacuum robots. `Apache-2.0` `JavaScript`
...
* [cartographer](https://github.com/cartographer-project/cartographer) ⭐ 7,945 | 🐛 242 | 🌐 C++ | 📅 2024-01-05 - A system that provides real-time simultaneous localization and mapping (SLAM) in 2D and 3D across multiple platforms and sensor configurations. `Apache-2.0` `C++`
...
* [Awesome Robotic Tooling](https://github.com/protontypes/awesome-robotic-tooling) ⭐ 3,880 | 🐛 13 | 📅 2023-11-20
