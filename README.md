...
[cartographer](https://github.com/cartographer-project/cartographer) ⭐ 7,966 | 🐛 241 | 🌐 C++ | 📅 2024-01-05 can easily be setup with IMU to improve localization.
...
* [Valetudo](https://github.com/Hypfer/Valetudo) ⭐ 9,651 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-04 - Cloud-free control webinterface for vacuum robots. `Apache-2.0` `JavaScript`
...
* [Gobot](https://github.com/hybridgroup/gobot/) ⭐ 9,468 | 🐛 100 | 🌐 Go | 📅 2026-01-07 - Golang framework for robotics, drones, and the Internet of Things (IoT).  `Apache-2.0` `golang`
...
* [cartographer](https://github.com/cartographer-project/cartographer) ⭐ 7,966 | 🐛 241 | 🌐 C++ | 📅 2024-01-05 - A system that provides real-time simultaneous localization and mapping (SLAM) in 2D and 3D across multiple platforms and sensor configurations. `Apache-2.0` `C++`
...
* [Awesome Robotic Tooling](https://github.com/protontypes/awesome-robotic-tooling) ⭐ 3,890 | 🐛 13 | 📅 2023-11-20
